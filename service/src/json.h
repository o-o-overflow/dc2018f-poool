...
struct json_value_s *json_get_value(struct json_object_s *obj, const char *name);

struct json_value_s *json_get_index(struct json_array_s *arr, unsigned idx);

#define ToString(v) (((struct json_string_s *)v->payload)->string)
